...
new
	...
	// name, color, modifier, spawn amount, value, mining rate
	    {"Copper", 0xB87333FF, 0.75, 50, 350, 75},
	    {"Amethyst", 0x9B59B6FF, 0.60, 40, 450, 67},
	    {"Emerald", 0x2ECC71FF, 0.40, 30, 750, 60},
		{"Ruby", 0xD10056FF, 0.35, 20, 800, 55},
		{"Sapphire", 0x0F52BAFF, 0.30, 15, 850, 50},
        {"Gold", 0xFFD700FF, 0.25, 10, 1000, 50}
	};
